...
public class UserInterface {
    ...
    public void construtor() {
        ...
        JLabel txtOrientado = new JLabel("Resize the main window");

        JDialog warning = new JDialog(j1, "warning", true, null);
                  warning.setSize(175, 150);
                  warning.setLayout(layout2);
                  warning.setResizable(true);
                  warning.add(txtOrientado);
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                jdb1.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        Deposito depo = new Deposito(cod, jtxtF2.getText(), jtxtF3.getText(), jtxtF4.getText(), capm);
                        gerenciador.cadastrarDeposito(depo);
        ...
        b2.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                jdb1.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        Integer cod = parseInt0(jtxtF1.getText());
                        Cliente cliente = new Cliente(cod, jtxtF2.getText(), jtxtF3.getText());
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        jdb1.addActionListener(new ActionListener() {
                            ...
                            public void actionPerformed(ActionEvent e) {
                                ...
                                Duravel duravel = new Duravel(jtxtF1.getText(), jtxtF2.getText(), volume, valor, Situacao.PENDENTE, jtxtF5.getText(), jtxtF6.getText());
                                gerenciador.cadastrarItem(duravel);
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        jdb1.addActionListener(new ActionListener() {
                            ...
                            public void actionPerformed(ActionEvent e) {
                                ...
                                double valor = Double.valueOf(jtxtF4.getText());
                                Integer volume = parseInt0(jtxtF3.getText());
                                Perecivel perecivel = new Perecivel(jtxtF1.getText(), jtxtF2.getText(), volume, valor, Situacao.PENDENTE, jtxtF5.getText(), jtxtF6.getText());
                                gerenciador.cadastrarItem(perecivel);
                                jd2.setVisible(false);
        ...
        JButton b5 = new JButton("Retirar item");
        b5.setSize(100, 100);
        b5.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e){
                JDialog jd = new JDialog(j1, "Retirar item", true, null);
                  jd.setSize(500, 150);
                  jd.setLayout(layout1);
                  jd.setResizable(true);
                  ...
                  jdb1.addActionListener(new ActionListener() {
                   ...
                   @Override
                    ...
                    public void actionPerformed(ActionEvent e){
                        gerenciador.alterarSituacao(jtxtF1.getText());
        ...
        b6.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e){
                ...
                mensagembala1.setText("Dados carregados com sucesso !");
                mensagembala1.setVisible(true);
            }
        });
        p1.add(b6);
        ...
        b7.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e){
                JDialog jd = new JDialog(j1, "Consultar itens armazenado", true, null);
                  jd.setSize(500, 150);
                  jd.setLayout(layout2);
                  jd.setResizable(true);
                  ...
                  public void actionPerformed(ActionEvent e){
                    String str = gerenciador.consultarItensArmazenados();
                  JTextArea jtxt2 = new JTextArea("Itens armazenados\n"+str);
                  jtxt2.setSize(500, 500);
                  jtxt2.setEditable(false);
                  jtxt2.setVisible(true);
                  jd.add(jtxt2);
                  mensagembala1.setText("Itens consultados com sucesso");
                  mensagembala1.setVisible(true);
                 }
                  });
                  jd.add(jdb1);
        ...
        b9.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e){
                JDialog jd = new JDialog(j1, "Dados.txt", true, null);
                  jd.setSize(500, 500);
                  jd.setLayout(layout2);
                  jd.setResizable(true);
                  ...
                  JTextArea ta1 = new JTextArea("Estes sao os dados salvos\n"+str);
                  ta1.setSize(10, 10);
